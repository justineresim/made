...
<div class="testing">
    ...
    <header>
        <div class="g-container">
            <h1 class="g-text-center">Bare</h1>
        </div>
    </header>
    <div class="g-container">
        <div class="testing-sidebar">
            <div class="testing-sidebar-inner">
                <ul class="testing-menu">
                    ...
                    <li><a class="test-scroll" scroll="#fgrid">Fixed Ratio Grid System</a></li>
                </ul>
            </div>
        </div>
...
<a class="g-btn g-btn-tertiary">Tertiary Button</a>
<a class="g-btn g-active g-btn-tertiary">Active State</a>
<a class="g-btn g-btn-tertiary g-disabled">Disabled</a></xmp></pre>
...
<pre><xmp><div class="line no-gutter">
    ...
    <div class="size1of4 sm-size1of2 xs-size1of2 unit">
        ...
        <h2 id="fgrid">Fixed Ratio Grid System</h2>
        <hr>

        <div class="f-container h-10">
            <div class="t-0 l-0 w-3 h-5 ">
                <div class="f-unit testing-unit-f" style="background-image: url(https://pixabay.com/static/uploads/photo/2015/10/12/11/27/nature-983667_960_720.jpg);"></div>
            </div>
            <div class="t-1 l-5 w-4 h-3">
                <div class="f-unit testing-unit-f" style="background-image: url(https://i.ytimg.com/vi/OdIJ2x3nxzQ/hqdefault.jpg);"></div>
            </div>
            <div class="h-6 w-4 t-2 l-2 p-1">
                <div class="f-unit testing-unit-f" style="background-image: url(http://cdn.banquenationale.ca/cdnbnc/2013/06/ruisseau.jpg);"></div>
            </div>
            <div class="h-6 w-2 t-6 l-1">
                <div class="f-unit testing-unit-f" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQ-d0FjFuug8jFDGiQxdYgrgxs1QZBLEe31rwzFOAoLoiyvmtS);"></div>
            </div>
            <div class="h-3 w-4 t-3 l-7">
                <div class="f-unit testing-unit-f" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnkN-AIc2qPVYO6Y8ot1Mqi4DZODWgc9WvBWBwkq1DSZ2i0_OzMw);"></div>
            </div>
            <div class="h-3 w-5 t-7 l-5">
                <div class="f-unit testing-unit-f" style="background-image: url(https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRnC9v2ycEITpInW-eqNeOCq0qSgKidpnGNSBv7ca38rUeA3SFb);"></div>
            </div>
        </div>

<pre><xmp><div class="f-container h-10">
    <div class="t-0 l-0 w-3 h-5 ">
        <div class="f-unit testing-unit-f" style="background-image: url(https://pixabay.com/static/uploads/photo/2015/10/12/11/27/nature-983667_960_720.jpg);"></div>
    </div>
    <div class="t-1 l-5 w-4 h-3">
    ...
    <div class="h-3 w-5 t-7 l-5">
        <div class="f-unit testing-unit-f" style="background-image: url(https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRnC9v2ycEITpInW-eqNeOCq0qSgKidpnGNSBv7ca38rUeA3SFb);"></div>
            ...
            <div class="f-container h-12">
                <div class="t-0 l-3 w-3 h-4">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>
                </div>
                <div class="t-0 l-0 w-3 h-8">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                </div>
                <div class="t-8 l-0 w-6 h-4">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                </div>
                <div class="t-4 l-3 w-6 h-4">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                </div>
                <div class="t-0 l-6 w-6 h-4">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                </div>
                <div class="t-4 l-9 w-3 h-8">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                    </div>
                <div class="t-8 l-6 w-3 h-4">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                </div>
            </div>

<pre><xmp><div class="f-container h-12">
    <div class="t-0 l-3 w-3 h-4">
        <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>
    </div>
    <div class="t-0 l-0 w-3 h-8">
    ...
    <div class="t-8 l-6 w-3 h-4">
        <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
            ...
            <div class="f-container no-gutter h-4">
                <div class="t-0 l-0 w-4 h-12">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>
                </div>
                <div class="t-0 l-4 w-4 h-12">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                </div>
                <div class="t-0 l-8 w-4 h-12">
                    <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>                
                </div>
            </div>
                
<pre><xmp><div class="f-container no-gutter h-4">
    <div class="t-0 l-0 w-4 h-12">
        <div class="f-unit testing-unit-f" style="background-image: url(http://smashinghub.com/wp-content/uploads/2010/07/nature-photography-16.jpg);"></div>
    </div>
    <div class="t-0 l-4 w-4 h-12">
